	  ...
	  <tbody>
	    ...
	    <tr>
	      ...
	      <td>
			...
			<td>
	      	<button class="btn btn-outline-danger px-3 py-0" data-toggle="modal" data-target="#warning-del<?php echo $key;?>">Hủy</button>
	      </td>
			  ...
			  <div class="modal-dialog modal-dialog-centered">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        ...
			        <h5 class="mb-0">Bạn thực sự muốn hủy lịch khám này?</h5>
			        <small>Lưu ý: Lịch khám chỉ có thể hủy sau 24h</small>
			      </div>
			      <div class="modal-footer">
			      	<form action="./mvc/controller/deleteappointment.php" method="POST">
			      	<input type="hidden" name="id_phieukham" value="<?php echo $val['id_phieukham'];?>">
			      	<button type="submit" class="btn btn-danger  px-3 py-0" name="del_lichhen">Xác nhận</button>
			      	</form>
			        <button type="button" class="btn btn-secondary px-3 py-0" data-dismiss="modal">Đóng</button>
