<?php
	...
	include './controller-mb/source.php';
?>
<?php
...
<div class="container">
  ...
  <tbody>
   <center><h2>Bệnh án của bệnh nhân <?php echo $username?></h2></center>
   <hr style="width:200px"><div style="text-align:right;margin-bottom:20px"> <a class="btn btn-outline-primary py-0 px-2" href="processappointment.php">Xem tất cả các bệnh nhân.</a></div>	
    ...
    <tr>
      ...
      <td><button class="btn btn-outline-primary py-0 px-2" data-toggle="modal" data-target="#chitiet">Chi tiết</button></td>
      <div class="modal fade" id="chitiet" tabindex="-1" role="dialog" aria-hidden="true">
