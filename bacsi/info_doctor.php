...
<div class="container">
  <div class="row">
      <div class="col-4 col-m-6 col-sm-4">
        <div class="counter bg-primary" style="border-radius: 45%">
          <p>
            <i class="fas fa-tasks"></i>
          </p>
          <center>
          <h3><?php if($lichsuchua){
            $key = 0;
	...
	<div class="row">
          ...
          <div class="col-3 text-center">
            <img src="./view-mb/image/anh_dai_dien/<?php echo $doctor['image'] == true ? $doctor['image'] :'demo_avatar.jpeg';?>" width="60%" height="70%">
