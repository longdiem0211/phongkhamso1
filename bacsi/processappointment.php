...
<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $user['fullname'] == false ? "<span class='font-italic font-weight-light'>Chưa cung cấp</span>": $user['fullname']; ;?></td>
      <td><?php echo $user['email'] == false ? "<span class='font-italic font-weight-light'>Chưa cung cấp</span>": $user['email']; ;?></td>
      <td>
      	<?php
      ...
      <td><a class="btn btn-outline-primary py-0 px-2" href="history_bs.php?ten=<?php echo $user['fullname'] ;?>">Xem bệnh án cá nhân</a></td>
			  ...
			  <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
					...
					<p><span class="font-weight-bolder">Mã phiếu khám : </span><span><?php echo $id_phieukham;?></span></p>
      ...
      <td><button class="btn btn-outline-primary py-0 px-2" data-toggle="modal" data-target="#lienhe<?php echo $key;?>">Liên hệ.</button></td>
     <?php include './controller-mb/sendmail.php'; ?>
      <div class="modal fade" id="lienhe<?php echo $key;?>" tabindex="-1" role="dialog" aria-hidden="true">
      	<div class="modal-dialog">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h5 class="modal-title">Xử lý phiếu khám</h5>
			      ...
			      <div class="modal-body">
			        ...
			        <p><span class="font-weight-bolder">Bệnh nhân: </span><span><?php echo $user['fullname'];?></span></p>
			        <p><span class="font-weight-bolder">Email: </span><span><?php echo $user['email'];?></span></p>
			        <p>
			        <label class="font-weight-bolder">Tiêu đề:</label><br>
			        <input type="text" name="sub" class="form-control" placeholder="Tiêu đề" ><br>
			    	</p>
			        <div class="form-group">
					    <label class="font-weight-bolder">Lời nhắn:</label>
					    <textarea class="form-control" name='msg' rows="3"></textarea>
					</div>
					<p>
			        <label class="font-weight-bolder">Đính kèm:</label><br>
			        <input type="file" name="attach1"/><br>
			    	</p>
			      <div class="modal-footer">
			      	<input type="submit" name="Send Mail" value="Send Mail" class="btn btn-success px-3 py-0"/>
			      	<!-- <button type="submit" name="xacnhan" class="btn btn-success px-3 py-0">Xác nhận</button> -->
			      	</form>
			        <a href="#" class="btn btn-secondary px-3 py-0" data-dismiss="modal">Đóng</a>
			      </div>
